  ...
  return (
    <Card className="p-8 backdrop-blur-xl bg-surface/80 border-white/10 shadow-2xl">
      ...
      <form className="space-y-4" onSubmit={onSubmit}>
        ...
        <div>
            <div className="flex items-center justify-between mb-1.5">
                ...
                <Link href="#" className="text-xs font-medium text-primary hover:text-primary-glow transition-colors">
                    Forgot password?
                </Link>
            </div>
            <Input 
      ...
      <p className="mt-8 text-center text-sm text-text-muted">
        ...
        <Link href="/signup" className="font-medium text-primary hover:text-primary-glow transition-colors">
            Sign up
        </Link>
      </p>
    </Card>
