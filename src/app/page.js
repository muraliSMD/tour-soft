        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card hoverEffect={true}>
              ...
              <h3 className="text-xl font-bold text-white mb-3">Multi-Game Support</h3>
              <p className="text-text-muted leading-relaxed">
                Whether it's Football, Basketball, or CS2, our adaptive automated brackets handle the rules for you.
              </p>
            </Card>
